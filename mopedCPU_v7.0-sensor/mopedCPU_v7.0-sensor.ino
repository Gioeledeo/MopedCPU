...
void cleanValue(){
  tft.fillRect(76,36,40,7,ST7735_BLACK);
  tft.fillRect(88,46,28,7,ST7735_BLACK);
  tft.fillRect(82,56,13,7,ST7735_BLACK);
  tft.fillRect(88,66,13,7,ST7735_BLACK);
  tft.fillRect(88,76,13,7,ST7735_BLACK);
  tft.fillRect(88,86,13,7,ST7735_BLACK);
  tft.fillRect(88,96,13,7,ST7735_BLACK);
  tft.fillRect(94,106,13,7,ST7735_BLACK);
  //tft.fillRect(0,129,128,30,ST7735_BLACK);
}
